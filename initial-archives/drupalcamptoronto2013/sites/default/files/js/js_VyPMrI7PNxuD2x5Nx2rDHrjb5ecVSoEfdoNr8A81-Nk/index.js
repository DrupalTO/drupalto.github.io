...
(function ($) {
  Drupal.behaviors.ATmenuToggle = {
    attach: function (context, settings) {
      ...
      $(".at-menu-toggle h2").removeClass('element-invisible').addClass('at-menu-toggle-button').wrapInner('<a href="#menu-toggle" class="at-menu-toggle-button-link ss-dropdown" />');
