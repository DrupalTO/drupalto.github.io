...
jQuery(document).ready(function(){
	...
	$('.more-link a').each(function(){
		...
		var last = moretext.lastIndexOf(" ");
	
	
		var newfirst = moretext.substr(0, last+1);	
		var newlast = moretext.substr(last+1, moretext.length);

		$(this).html(newfirst+'<strong>'+newlast+'</strong>');
	});
